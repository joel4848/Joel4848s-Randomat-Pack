...
util.AddNetworkString("Rdmt_Joel4848_RewardPunish_ChangedFOVBegin")

PUNISHMENT.Name = "Changed FOV"
PUNISHMENT.Id = "changedfov"

local fov_scale = CreateConVar("rdmt_joel4848_rewardpunish_changedfov_scale", 1.5, {FCVAR_NONE, FCVAR_NOTIFY}, "FOV increase scale", 1.1, 2.0)
local fov_scale_ironsight = CreateConVar("rdmt_joel4848_rewardpunish_changedfov_scale_ironsight", 1.0, {FCVAR_NONE, FCVAR_NOTIFY}, "Ironsighted FOV increase scale", 0.8, 2.0)
...
function PUNISHMENT:Apply(target)
    ...
    local timerId = "Rdmt_Joel4848_RewardPunish_ChangedFOV_" .. target:SteamID64()
    ...
    net.Start("Rdmt_Joel4848_RewardPunish_ChangedFOVBegin")
    net.Send(target)
