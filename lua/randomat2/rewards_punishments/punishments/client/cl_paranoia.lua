...
net.Receive("Rdmt_Joel4848_RewardPunish_ParanoiaBegin", function()
    local delay_min = net.ReadUInt(8)
    local delay_max = math.max(delay_min, net.ReadUInt(8))
    startTimer("Rdmt_Joel4848_RewardPunish_Paranoia", Randomat.Client, delay_min, delay_max)
end)

net.Receive("Rdmt_Joel4848_RewardPunish_ParanoiaEnd", function()
    timer.Remove("Rdmt_Joel4848_RewardPunish_Paranoia")
end)