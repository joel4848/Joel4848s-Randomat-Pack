...
net.Receive("Rdmt_Joel4848_RewardPunish_WeaponJamsStart", function()
...
net.Receive("Rdmt_Joel4848_RewardPunish_WeaponJamsStop", function()
    local weap_class = net.ReadString()
    local weap = Randomat.Client:GetWeapon(weap_class)
    if not IsValid(weap) then return end
    UnjamWeapon(weap)
...
net.Receive("Rdmt_Joel4848_RewardPunish_WeaponJamsEnd", function()
