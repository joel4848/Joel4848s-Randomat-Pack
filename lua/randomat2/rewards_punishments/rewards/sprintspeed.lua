...
REWARD.Name = "Sprint Speed Boost"
REWARD.Id = "sprintspeed"

local sprintspeed_mult = CreateConVar("rdmt_joel4848_rewardpunish_sprintspeed_mult", 1.25, FCVAR_NONE, "Speed multiplier (1.25=125%, a 25% boost).", 1.05, 2)

local multIds = {}
local multIdPrefix = "Joel4848_RewardPunish_SprintSpeed_"
